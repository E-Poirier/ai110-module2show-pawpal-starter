...
- I am fairly confident for the behaviors above because they are automated. With more time I would add tests for duplicate task title very large task lists and unicode in titles to ensure the UI and scheduler stay robust.
...
- A next iteration could addowner preferences (e.g. “walks only in the morning”) as constraints, or recurring tasks and a smarter objective than pure greedy packing if the course allows.
